...
})(TestCaseStatus = exports.TestCaseStatus || (exports.TestCaseStatus = {}));
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            runName = this.testrailConfig.testRun + " (" + userAgentsDetails[0] + "_" + userAgentsDetails[1] + ")";
                            runDetails = {
                                suite_id: suite.id,
                                include_all: false,
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: " + JSON.stringify(e_1.message, null, 2)));
                            process.exit(1);
                            return [3, 3];
                    ...
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: " + JSON.stringify(e_2.message, null, 2)));
                            process.exit(1);
                            return [3, 5];
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: " + JSON.stringify(e_3.message, null, 2)));
                            process.exit(1);
                            return [3, 3];
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: " + JSON.stringify(e_4.message, null, 2)));
                            process.exit(1);
                            return [3, 3];
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: " + JSON.stringify(e_5.message, null, 2)));
                            process.exit(1);
                            return [3, 3];
                        case 3: return [2];
                    }
