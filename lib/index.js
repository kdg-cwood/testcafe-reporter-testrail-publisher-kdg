...
exports.TestCaseStatus = void 0;
Object.defineProperty(exports, '__esModule', { value: true });
var TestrailApi = require('testrail-api');
var TestCaseStatus;
(function (TestCaseStatus) {
    TestCaseStatus[TestCaseStatus["Unknown"] = 0] = "Unknown";
    TestCaseStatus[TestCaseStatus["Passed"] = 1] = "Passed";
    TestCaseStatus[TestCaseStatus["Blocked"] = 2] = "Blocked";
    TestCaseStatus[TestCaseStatus["Untested"] = 3] = "Untested";
    TestCaseStatus[TestCaseStatus["Retest"] = 4] = "Retest";
    TestCaseStatus[TestCaseStatus["Failed"] = 5] = "Failed";
        ...
        reportTaskStart: function (startTime, userAgents, testCount) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    logWithFormat.bind(this, "Running tests in: ".concat(this.userAgents), this.chalk.greenBright)();
                    return [2];
                });
            });
        },
        reportFixtureStart: function (name, path) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    logWithFormat.bind(this, "Fixture: ".concat(this.fixtureName), this.chalk.black)();
                    return [2];
                });
            });
        },
        reportTestDone: function (name, testRunInfo) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    this.write("".concat(logger(testStatus), " - ").concat(name)).newline();
                    error = '';
                    if (errs.length) {
                        errs.forEach(function (err, idx) {
                            error += _this.formatError(err, "".concat(idx + 1, ") ")).replace(/[\u001b\u009b][[()#;?]*(?:[0-9]{1,4}(?:;[0-9]{0,4})*)?[0-9A-ORZcf-nqry=><]/g, '');
                        });
                    }
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (this.skippedCount > 0) {
                                this.write(this.chalk.cyan("".concat(this.skippedCount, " Skipped"))).newline();
                            }
                            footer = passed === this.testCount
                                ? "".concat(this.testCount, " Passed")
                                : "".concat(this.testCount - passed, "/").concat(this.testCount, " Failed");
                            footer += " (Duration: ".concat(duration, ")");
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                            ...
                            for (index = 0; index < this.testResult.length; index++) {
                                ...
                                if (testCaseParts.length < 3) {
                                    this.newline()
                                        ...
                                        .write("Warning:  Test: ".concat(this.chalk.red.bold(name), " does not contains the correct format: \"<Test Type> | <Test Name> | <TestRail Test Case ID>\""));
                                    continue;
                                }
                                if (testCaseParts.length > 3) {
                                    this.newline()
                                        .write(this.chalk.red.bold(this.symbols.err))
                                        .write("Warning:  Test: ".concat(this.chalk.red.bold(name), " contains invalid character \"|\""));
                                    continue;
                                }
                                ...
                                if (typeof testCaseIdString === 'undefined') {
                                    this.newline()
                                        .write(this.chalk.red.bold(this.symbols.err))
                                        .write("Warning:  Test: ".concat(this.chalk.red.bold(name), " missing the Testrail CaseId"));
                                    continue;
                                }
                                ...
                                if (isNaN(Number(testCaseId))) {
                                    this.newline()
                                        .write(this.chalk.red.bold(this.symbols.err))
                                        .write("Warning:  Test: ".concat(this.chalk.red.bold(name), " contains invalid Testrail CaseId"));
                                    continue;
                                }
                        ...
                        case 3:
                            ...
                            runName = "".concat(this.testrailConfig.testRun, " (").concat(userAgentsDetails[0], "_").concat(userAgentsDetails[1], ")");
                            runDetails = {
                                suite_id: suite.id,
                                include_all: false,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                .write(this.chalk.red.bold(this.symbols.err))
                                .write(this.chalk.red("Error getting the project ".concat(testRailConfig.projectName)))
                                .newline()
                                .write(this.chalk.red("Error: ".concat(JSON.stringify(e_1.message, null, 2))));
                            process.exit(1);
                            return [3, 3];
                    ...
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: ".concat(JSON.stringify(e_2.message, null, 2))));
                            process.exit(1);
                            return [3, 5];
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: ".concat(JSON.stringify(e_3.message, null, 2))));
                            process.exit(1);
                            return [3, 3];
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: ".concat(JSON.stringify(e_4.message, null, 2))));
                            process.exit(1);
                            return [3, 3];
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: ".concat(JSON.stringify(e_5.message, null, 2))));
                            process.exit(1);
                            return [3, 3];
                        case 3: return [2];
                    }
