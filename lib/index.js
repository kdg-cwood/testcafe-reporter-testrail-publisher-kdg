    ...
    return {
        ...
        reportTaskStart: function (startTime, userAgents, testCount) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    logWithFormat.bind(this, "Running ".concat(this.count, " tests in: ").concat(this.userAgents), this.chalk.greenBright)();
                    return [2];
                });
            });
        },
        ...
        _getProjectOrThrowAndExit: function (testrailApi, testRailConfig) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, testrailApi.getProjects()];
                        case 1:
                            body = (_a.sent()).body;
                            return [2, body.projects.find(function (p) { return p.name === testRailConfig.projectName; })];
                    }
                });
            });
        },
        _getPlanOrThrowAndExit: function (testrailApi, testRailConfig, project) {
            return __awaiter(this, void 0, void 0, function () {
                var plan, body, result, e_1, error;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 4, , 5]);
                        ...
                        case 4:
                            ...
                            this.newline()
                                ...
                                .newline()
                                .write(this.chalk.red("Error: ".concat(JSON.stringify(error.message, null, 2))));
                            process.exit(1);
                            return [3, 5];
        ...
        _addPlanEntryOrThrowAndExit: function (testrailApi, plan, runDetails) {
            return __awaiter(this, void 0, void 0, function () {
                var planEntryResult, body, e_3, error;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
